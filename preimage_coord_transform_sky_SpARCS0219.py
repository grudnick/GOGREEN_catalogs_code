...
'''Run with
import preimage_coord_transform_sky_SpARCS0219 as pcts

#this matches the input and reference catalog and runs geomap and
#geoxytran on these catalogspct.cat_match_SpARCS0219(septol, fullcat_trans = 1)
pcts.cat_match_sky_SpARCS0219(3.0, fullcat_trans = 1)


'''

def cat_match_sky_SpARCS0219(septol, **kwargs):
    ...
    (gg_dat, ref_dat, gg_catname, ref_catname, zcat_dat, zcat, speczcatname) = cat_read_SpARCS0219()
    #print(gg_dat)
...
#    cat_trans_sky('/Users/grudnick/Work/GOGREEN/Catalogs/Preimaging/SpARCS0219/SPARCS0219_phot_v2.0_USE.fits', 'SpARCS0219_geomap.db', './geomap_coords.SpARCS0219.in','./SpARCS0219_J1.v0.cat', 'SpARCS0219', 3.0)
...
def cat_read_SpARCS0219():
    ...
    speczcat = "/Users/grudnick/Work/GOGREEN/Data/Spectroscopy/v0.3/SpARCS0219_final.fits"
    #speczcat = "/Users/grudnick/Work/GOGREEN/Data/Spectroscopy/v0.3/SpARCS0219_oned.fits"
