...
'''Run with
import preimage_coord_transform_sky_SpARCS1634 as pcts

#this matches the input and reference catalog and runs geomap and
#geoxytran on these catalogspct.cat_match_SpARCS1634(septol, fullcat_trans = 1)
pcts.cat_match_sky_SpARCS1634(3.0, fullcat_trans = 1)


'''

#main program#
def cat_match_sky_SpARCS1634(septol, **kwargs):
    ...
    clustname = 'SpARCS1634'
    (gg_dat, ref_dat, gg_catname, ref_catname, speczcatname) = cat_read_SpARCS1634()
    #print(gg_dat)
    ...
    #catpath = '/Users/grudnick/Work/GOGREEN/Catalogs/Astrometric/SpARCS1634'
    catpath = '.'
...
#    cat_trans_sky('/Users/grudnick/Work/GOGREEN/Catalogs/Preimaging/SpARCS1634/SPARCS0219_phot_v2.0_USE.fits', 'SpARCS1634_geomap.db', './geomap_coords.SpARCS1634.in','./SpARCS1634_J1.v0.cat', 'SpARCS1634', 3.0)
