...
'''Run with
import preimage_coord_transform_sky_SpARCS1051 as pcts

#this matches the input and reference catalog and runs geomap and
#geoxytran on these catalogspct.cat_match_SpARCS1051(septol, fullcat_trans = 1)
pcts.cat_match_sky_SpARCS1051(3.0, fullcat_trans = 1)


'''

#main program#
def cat_match_sky_SpARCS1051(septol, **kwargs):
    ...
    clustname = 'SpARCS1051'
    (gg_dat, ref_dat, gg_catname, ref_catname, speczcatname) = cat_read_SpARCS1051()
    #print(gg_dat)
    ...
    #catpath = '/Users/grudnick/Work/GOGREEN/Catalogs/Astrometric/SpARCS1051'
    catpath = '.'
...
#    cat_trans_sky('/Users/grudnick/Work/GOGREEN/Catalogs/Preimaging/SpARCS1051/SPARCS0219_phot_v2.0_USE.fits', 'SpARCS1051_geomap.db', './geomap_coords.SpARCS1051.in','./SpARCS1051_J1.v0.cat', 'SpARCS1051', 3.0)
...
def cat_read_SpARCS1051():

    #read in catalogs

    #official GOGREEN imaging catalog
    catgogreen = '/Users/grudnick/Work/GOGREEN/Catalogs/Preimaging/SpARCS1051/SPARCS1051_zband_IRAC_v2_handcheck_cat.fits'
    ...
    #refcat = '/Users/grudnick/Work/GOGREEN/Catalogs/Astrometric/SpARCS1051/SpARCS1051_J.v0.sexcat' 
    #ref_dat = ascii.read(refcat)

    #this is a GAIA reference catalog
    refcat = '/Users/grudnick/Work/GOGREEN/Catalogs/Astrometric/GOGREEN_GAIA/sparcs1051_gaia_votable.xml'
    votable = parse(refcat)
    table = votable.get_first_table()
    ref_dat = table.array

    #read the catalog spectroscopic redshifts
    speczcat = "/Users/grudnick/Work/GOGREEN/Data/Spectroscopy/v0.3/SpARCS1051_final.fits"
